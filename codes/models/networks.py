...
def define_D(opt, dp_device_ids, local_rank):
    ...
    elif which_model == 'discriminator_vgg_IS':
        netD = arch.Discriminator_VGG_IS(in_nc=opt_net['in_nc'], base_nf=opt_net['nf'], \
            norm_type=opt_net['norm_type'], mode=opt_net['mode'], act_type=opt_net['act_type'])
...
def sphere(opt, dp_device_ids, local_rank, use_bn=False):
    ...
    pretrain_model = "models/sphere20a.pth"
    netS = sphere20a(feature=True)
